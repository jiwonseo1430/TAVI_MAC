...
- [x] fig2_spline = 2-panel: A 1-year mortality (log2 MAC HR 1.17, linearity
      OK) / B whole follow-up
- [x] fig1_km_2panel = 2-panel whole-period KM: A binary (p=0.006) / B median
      3-group (p=0.021), 7-year cap
